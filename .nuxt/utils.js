...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"MEDIA_SERVER":"//cdn.mr007.co/images","API_MR":"http://35.201.183.109:1341","API_MRTV":"https://www.mr007.tv","API_MR_JAVA":"http://service.mr007.com:8081/mr/api/z/games/account"}
    }
    // Only set once
